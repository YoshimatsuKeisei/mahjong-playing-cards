...
const manualPage4ImageSrc = new URL("../../鳴き解説-page4.png", import.meta.url)
  .href;
const manualPage5ImageSrc = new URL("../../得点計算-page5.png", import.meta.url)
  .href;
  ...
  return (
    <main className="screen manual-screen">
      <section className="scroll-panel" aria-label="ルール説明">
        ...
        <article className={`scroll-paper manual-page-${pageIndex + 1}`}>
          <h1>{page.title}</h1>
          {page.illustration && (
