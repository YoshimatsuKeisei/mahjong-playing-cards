...
export default function RoomSelectScreen({ onBackHome, onCreateRoom, onJoinRoom }: RoomSelectScreenProps) {
  return (
    <main className="screen room-choice-screen">
      <section className="room-choice-panel room-select-panel">
        ...
        <div className="room-choice-options">
          <button
            type="button"
            className="room-choice-card room-select-create-button"
            data-testid="local-create-room-choice"
          ...
          <button
            type="button"
            className="room-choice-card room-select-join-button"
            data-testid="online-join-room-choice"
            onClick={onJoinRoom}
          >
        ...
        <div className="room-choice-actions">
          <button
            type="button"
            className="secondary-button room-select-back-button"
            onClick={onBackHome}
          >
            ホーム画面に戻る
          </button>
